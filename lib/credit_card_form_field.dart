...
class Strings {
  ...
  static const String fieldReq = 'กรุณากรอกข้อมูล';
  static const String numberIsInvalid = 'บัตรไม่ถูกต้อง';
...
class CardUtils {
  ...
  static Widget getCardIcon(CardType cardType) {
    String img = "";
    Icon? icon; // ใช้ Icon? เพื่อให้รองรับค่า null ได้
    switch (cardType) {
    ...
    if (img.isNotEmpty) {
      ...
      // ถ้ามีการกำหนด icon ก็ให้ return icon
      return icon;
    } else {
      // หากไม่มีการกำหนดทั้ง img และ icon ก็สามารถแสดง widget ที่ต้องการ
      return SizedBox(); // หรืออาจใช้ widget ที่เหมาะสมอื่นๆ
    }
  }
